...
let LocalAdminStrategy = class LocalAdminStrategy extends passport_1.PassportStrategy(passport_local_1.Strategy, 'local-admin') {
    ...
    async validate(email, password) {
        ...
        if (!user || user.type != user_type_enum_1.UserTypeEnum.admin) {
